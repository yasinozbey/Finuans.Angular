...
var NumberBoxMask = NumberBoxBase.inherit({
    ...
    _tryParse: function(text, selection, char) {
        ...
        parsed = isNaN(parsed) ? void 0 : parsed;
    ...
    _escapePercentFormat: function(format) {
        return format.replace(/'([^']*)%([^']*)'/g, "'$1|$2'").replace("%", "'%'").replace("|", "%")
    },
    ...
    _isIncomplete: function(string) {
        var decimalSeparator = number.getDecimalSeparator(),
            ...
            lastKeyIncomplete = this._lastKey === decimalSeparator || "0" === this._lastKey;
    ...
    _formatValue: function() {
        ...
        var caretDelta, format = this._getFormatPattern(),
        ...
        if (this._formattedValue !== text) {
            ...
            if (void 0 !== parsedValueByText && null !== parsedValueByText) {
