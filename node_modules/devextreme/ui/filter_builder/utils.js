...
var DEFAULT_DATA_TYPE = "string",
    ...
    AVAILABLE_FIELD_PROPERTIES = ["caption", "customizeText", "dataField", "dataType", "editorTemplate", "falseText", "filterOperations", "format", "lookup", "trueText"];
...
function addItem(item, group) {
    ...
    if (0 === criteria.length) {
        ...
        if (lastItemIsGroupOperation) {
            criteria[1 === criteria.length ? "unshift" : "push"](item)
        } else {
            if (isCriteriaContainValueItem(criteria)) {
...
function getNormalizedFilter(group, fields) {
    ...
    var groupValue = getGroupValue(criteria);
    var lastItemIsGroupOperation = criteria[criteria.length - 1] === groupValue;
    if (1 === criteria.length && lastItemIsGroupOperation) {
        return null
    }
    if (lastItemIsGroupOperation) {
