...
function logarithmicGenerator(options) {
    ...
    return generator(options, getBusinessDeltaLog(base), calculateTickIntervalLog, calculateMinorTickInterval, getTickIntervalByCustomTicks(log, getValue), getTickIntervalByCustomTicks(getValue, getValue), getValue, calculateTicks(addIntervalLog(base), options.endOnTick ? floor : ceil, adjustIntervalLog), calculateMinorTicks(updateTickInterval, addInterval, floor, ceilNumber, ceil), getScaleBreaksProcessor(getValue, log, function(value, correction) {
